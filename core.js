// React is loaded via CDN, no need for imports
// GSAP and plugins are loaded via CDN
...
class Page extends React.Component {
  ...
  componentDidMount() {
    ...
    // Initial visibility: triangle visible, square hidden
    TweenMax.set(this.triangle, { opacity: 1 });
    TweenMax.set(this.square, { opacity: 0 });
  ...
  animFire(splitText) {
    ...
    // Triangle state: triangle on, square off
    TweenMax.set(this.triangle, { opacity: 1 });
    TweenMax.set(this.square, { opacity: 0 });
  ...
  animBack() {
    ...
    tl.add('start3');
    // Square state: triangle off, square on
    TweenMax.set(this.triangle, { opacity: 0 });
    TweenMax.set(this.square, { opacity: 1 });
    tl.to(this.hero, 0.5, {
      z: 0,
      rotationX: 0,
      y: 0,
  ...
  animMap(splitText) {
    ...
    tl.add('start2');
    // Map state: hide triangle and square
    TweenMax.set(this.triangle, { opacity: 0 });
    TweenMax.set(this.square, { opacity: 0 });
    tl.to(this.hero, 0.5, {
      z: 20,
    ...
    return (
      <div className="hero-area" ref={c => this.heroarea = c}>
        <svg className="hero" ref={c => this.hero = c} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1054.9 703.6">
          ...
          <rect id="square" ref={c => this.square = c} x="417.9" y="268.9" width="217" height="217" fill="none" stroke="#fff" stroke-miterlimit="10" stroke-width="9"/>
          <polygon id="triangle" ref={c => this.triangle = c} points="525.6 271.6 650 487 401.2 487 525.6 271.6" fill="none" stroke="#fff" stroke-miterlimit="10" stroke-width="9"/>
      ...
      <div className="textarea" ref={c => this.text = c}>
        ...
        <div className="staggerP" ref={c => this.staggerP = c}>
          <p>UI Designer · Full-Stack Engineer · Data Science</p>

          <p>Projects — Top 3</p>
          <p>CamGPT – Enterprise AI Assistant</p>
          <p>Python/Django + Vue · Automated workflows · Usage analytics</p>
          <p>Designed enterprise chatbot using OpenAI models. Delivered APIs, state management, and reporting dashboards.</p>

          <p>Toxic Comment Classifier</p>
          <p>DistilBERT + DeBERTa · Macro-F1 ↑ 0.66 → 0.73</p>
          <p>Fine-tuned transformers with Focal Loss + FGSM. Built interactive Gradio app with explainability.</p>

          <p>AI Recycling Detection</p>
          <p>Spectroscopy + ML · Predictive Material Analysis</p>
          <p>Modeled photoluminescence signals to detect recyclables. Predicted PVA mass, calcination temp, Mg doping ratio.</p>

          <p>Experience</p>
          <p>American Fidelity — Data Science Intern · Aug 2025 – Present</p>
          <p>Built OpenAI-powered chatbot with Django + Vue to automate workflows. Designed APIs, conversation state storage, and analytics dashboards.</p>
          <p>PwC (PricewaterhouseCoopers) — Associate → Associate 2 · Sep 2021 – Dec 2023</p>
          <p>Improved Guidewire UI & automation workflows, boosting efficiency. Reduced system bugs, mentored juniors, and led cross-functional meetings.</p>
          <p>Zensar Technologies — Senior Software Developer · Apr 2024 – Aug 2024</p>
          <p>Developed interactive dashboards with React + SQL for real-time analytics. Integrated APIs, optimized backend queries, and improved UI performance.</p>
          <p>University of South Florida — MS, Artificial Intelligence & Business Analytics · Aug 2024 – Jul 2026</p>
          <p>Coursework: Machine Learning, Deep Learning. Independent studies on AI recycling detection & toxic comment classification.</p>

          <p>About</p>
          <p>I’m Saran, a UI-focused full-stack engineer and AI practitioner. With experience at PwC, Zensar, and American Fidelity, I design end-to-end solutions that turn AI research into usable products.</p>

          <p>Contact</p>
          <p>Email: srangisetti@usf.edu</p>
          <p>LinkedIn: linkedin.com/in/sai-saran-rangisetti-5791061a1/</p>
          <p>GitHub: github.com/srangisetti27</p>
          <p>© Saran</p>
        </div>
      </div>
    </div>
